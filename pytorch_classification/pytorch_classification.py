...
if __name__ == '__main__':
    ...
    parser.add_argument('--load-weights', nargs='+', type=str, default='gesture_numbers_CNNModel_epoch25_personal.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--train-data',  type=str, default='', help='triggers training and declares data location')
    ...
    parser.add_argument('--contrast', type=float, default=1, help='edit roi for better cnn recognition')
    parser.add_argument('--brightness', type=float, default=1, help='edit roi for better cnn recognition')
